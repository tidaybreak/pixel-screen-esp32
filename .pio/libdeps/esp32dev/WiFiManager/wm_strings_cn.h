...
"<form action='/wifi'    method='get'><button>无线自动配置</button></form><br/>\n", // MENU_WIFI
"<form action='/0wifi'   method='get'><button>无线手动配置</button></form><br/>\n", // MENU_WIFINOSCAN
"<form action='/info'    method='get'><button>信息</button></form><br/>\n", // MENU_INFO
"<form action='/param'   method='get'><button>配置</button></form><br/>\n",//MENU_PARAM
...
"<form action='/erase'   method='get'><button class='D'>出厂配置</button></form><br/>\n", // MENU_ERASE
...
const char HTTP_FORM_WIFI[]        PROGMEM = "<label for='s'>SSID</label><input id='s' name='s' maxlength='32' autocorrect='off' autocapitalize='none' placeholder='{v}'><br/><label for='p'>密码</label><input id='p' name='p' maxlength='64' type='password' placeholder='{p}'><input type='checkbox' onclick='f()'> 显示密码";
...
const char HTTP_PARAMSAVED[]       PROGMEM = "<div class='msg S'>保存<br/></div>";
...
const char HTTP_STATUS_ON[]        PROGMEM = "<div class='msg S'><strong>热点:</strong>  {v}<br/><em><small> IP {i}</small></em></div>";
...
const char HTTP_STATUS_OFFNOAP[]   PROGMEM = "<br/>AP不可用";   // WL_NO_SSID_AVAIL
const char HTTP_STATUS_OFFFAIL[]   PROGMEM = "<br/>连接失败"; // WL_CONNECT_FAILED
const char HTTP_STATUS_NONE[]      PROGMEM = "<div class='msg'>未配置无线</div>";
...
const char HTTP_INFO_aboutver[]     PROGMEM = "<dt>WiFiManagerx</dt><dd>{1}</dd>";
...
const char S_brand[]              PROGMEM = "系统管理";
...
const char S_resetting[]          PROGMEM = "模块将在几秒钟内重启。";
const char S_closing[]            PROGMEM = "您可以关闭页面";
